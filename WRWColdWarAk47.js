function ColdWarAk47() {
    if (primary_attachments1 === 1 || primary_attachments2 === 1 || primary_attachments3 === 1 || primary_attachments4 === 1 || primary_attachments5 === 1) {
        ...
        if (muzzle == 4) {
            document.getElementById("muzzle").innerHTML ="Muzzle: Spetzanz Compensator";
            
        }
        if (muzzle == 5) {
            document.getElementById("muzzle").innerHTML ="Muzzle: KGB Eliminator";
            
        }
        if (muzzle == 6) {
            document.getElementById("muzzle").innerHTML ="Muzzle: GRU Suppressor";
    ...
    if (primary_attachments1 === 2 || primary_attachments2 === 2 || primary_attachments3 === 2 || primary_attachments4 === 2 || primary_attachments5 === 2) {
        ...
        if (body == 3) {
            document.getElementById("body").innerHTML ="Body: KGB Target Designator";
            
        }
        if (body == 4) {
            document.getElementById("body").innerHTML ="Body: GRU 5mw Laser Light";
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: 15.5\" Ultralight";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: 16.5\" Calvary Lancer";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: 18.2\" VDV Reinforced";
            
        }
        if (barrel == 4) {
            document.getElementById("barrels").innerHTML ="Barrels: 20\" Liberator";
        ...
        if (barrel == 6) {
            document.getElementById("barrels").innerHTML ="Barrels: 20\" Spetsnaz RPK Barrel";
    ...
    if (primary_attachments1 === 4 || primary_attachments2 === 4 || primary_attachments3 === 4 || primary_attachments4 === 4 || primary_attachments5 === 4) {
        ...
        if (optic == 8) {    
            document.getElementById("optic").innerHTML ="Optics: Hawksmoor";
        ...
        if (optic == 12) {
            document.getElementById("optic").innerHTML ="Optics: Noch Sova Thermal";
    ...
    if (primary_attachments1 === 5 || primary_attachments2 === 5| primary_attachments3 === 5 || primary_attachments4 === 5 || primary_attachments5 === 5) {
        ...
        if (stock == 2) {
            document.getElementById("stock").innerHTML ="Stock: Wire Stock";
        ...
        if (stock == 5) {
            document.getElementById("stock").innerHTML ="Stock: Spetsnaz PKM Stock";
            
        }
        if (stock == 6) {
            document.getElementById("stock").innerHTML ="Stock: KGB Skeletal Stock";
    ...
    if (primary_attachments1 === 6 || primary_attachments2 === 6 || primary_attachments3 === 6 || primary_attachments4 === 6 || primary_attachments5 === 6) {
        ...
        if (handle == 4) {
            document.getElementById("handle").innerHTML ="Handle: Spetsanz Field Wrap";
        ...
        if (handle == 6) {
            document.getElementById("handle").innerHTML ="Handle: GRU Elastic Wrap";
    ...
    if (primary_attachments1 === 7 || primary_attachments2 === 7 || primary_attachments3 === 7 || primary_attachments4 === 7 || primary_attachments5 === 7) {
        if (mag == 1) {
            document.getElementById("mag").innerHTML ="Magazine: 40 Rd";
            
        }
        if (mag == 2) {
            document.getElementById("mag").innerHTML ="Magazine: Taped Mags";
            
        }
        if (mag == 3) {
            document.getElementById("mag").innerHTML ="Magazine: 40 Rd Speed Mags";
            
        }
        if (mag == 4) {
            document.getElementById("mag").innerHTML ="Magazine: Bakelite 50 Rd";
            
        }
        if (mag == 5) {
            document.getElementById("mag").innerHTML ="Magazine: CRU Mag Clamp";
            
        }
        if (mag == 6) {
            document.getElementById("mag").innerHTML ="Magazine: VDV 50 Rd Fast Mag";
    ...
    if (primary_attachments1 === 8 || primary_attachments2 === 8 || primary_attachments3 === 8 || primary_attachments4 === 8 || primary_attachments5 === 8) {
        ...
        if (underbarrel == 5) {
            document.getElementById("underbarrel").innerHTML ="Underbarrel: Spetsnaz Grip";
            
        }
        if (underbarrel == 6) {
            document.getElementById("underbarrel").innerHTML ="Underbarrel: Spetsnaz Speedgrip";
