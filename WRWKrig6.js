function krig6() {
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: 16.5\" Ultralight";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: 17.7\" Calvary Lancer";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: 15.5\" Cantour";
            
        }
        if (barrel == 4) {
            document.getElementById("barrels").innerHTML ="Barrels: 19.7\" Liberator";
            
        }
        if (barrel == 5) {
            document.getElementById("barrels").innerHTML ="Barrels: 19.7\" Takedown";
            
        }
        if (barrel == 6) {
            document.getElementById("barrels").innerHTML ="Barrels: 15\" CMV Mil-Spec";
    ...
    if (primary_attachments1 === 7 || primary_attachments2 === 7 || primary_attachments3 === 7 || primary_attachments4 === 7 || primary_attachments5 === 7) {
        ...
        if (mag == 4) {
            document.getElementById("mag").innerHTML ="Magazine: STANAG 50 Rd";
        ...
        if (mag == 6) {
            document.getElementById("mag").innerHTML ="Magazine: Salvo 50 Rd Fast Mag";
