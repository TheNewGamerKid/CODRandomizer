function em2() {
    if (primary_attachments1 === 1 || primary_attachments2 === 1 || primary_attachments3 === 1 || primary_attachments4 === 1 || primary_attachments5 === 1) {
        if (muzzle == 1) {
            document.getElementById("muzzle").innerHTML ="Muzzle: Muzzle Brake .280";
            
        }
        if (muzzle == 2) {
            document.getElementById("muzzle").innerHTML ="Muzzle: Flashguard .280";
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: 23.5\" Ultralight";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: 22.9\" Calvary Lancer";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: 25.1\" Reinforced Heavy";
            
        }
        if (barrel == 4) {
            document.getElementById("barrels").innerHTML ="Barrels: 27.4\" Ranger";
            
        }
        if (barrel == 5) {
            document.getElementById("barrels").innerHTML ="Barrels: 26.3\" Takedown";
            
        }
        if (barrel == 6) {
            document.getElementById("barrels").innerHTML ="Barrels: 25.8\" Task Force";
    ...
    if (primary_attachments1 === 7 || primary_attachments2 === 7 || primary_attachments3 === 7 || primary_attachments4 === 7 || primary_attachments5 === 7) {
        if (mag == 1) {
            document.getElementById("mag").innerHTML ="Magazine: 30 Rd";
        ...
        if (mag == 4) {
            document.getElementById("mag").innerHTML ="Magazine: STANAG 40 Rd";
