...
export default class MW_M4A1 extends React.Component {
    constructor() {
        super();
...
function M4a1() {
    ...
    if (primary_attachments1 === 1 || primary_attachments2 === 1 || primary_attachments3 === 1 || primary_attachments4 === 1 || primary_attachments5 === 1) {
        max_muzzle++
        muzzle = Math.floor(Math.random() * (max_muzzle - min_muzzle) + min_muzzle)
        if (muzzle == 1) {
        ...
        if (muzzle == 7) {
            document.getElementById("muzzle").innerHTML ="Muzzle: Breacher Device";
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        max_barrel = max_barrel - 1
        barrel = Math.floor(Math.random() * (max_barrel - min_barrel) + min_barrel)
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: FSS 11.5\" Commando";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: Stock M16 Grenadier";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: FSS 14.5\" Tac Lite";
            
        }
        if (barrel == 4) {
            document.getElementById("barrels").innerHTML ="Barrels: Corvus Custom Marksman";
            
        }
        if (barrel == 5) {
            document.getElementById("barrels").innerHTML ="Barrels: FSS 12.4\" Predator";
    ...
    if (primary_attachments1 === 5 || primary_attachments2 === 5| primary_attachments3 === 5 || primary_attachments4 === 5 || primary_attachments5 === 5) {
        ...
        if (stock == 1) {
            document.getElementById("stock").innerHTML ="Stock: M16 stock";
            
        }
        if (stock == 2) {
            document.getElementById("stock").innerHTML ="Stock: Singuard Arms Invader";
        ...
        if (stock == 4) {
            document.getElementById("stock").innerHTML ="Stock: Forge TAC CQS";
    ...
    if (primary_attachments1 === 7 || primary_attachments2 === 7 || primary_attachments3 === 7 || primary_attachments4 === 7 || primary_attachments5 === 7) {
        ...
        if (mag == 1) {
            document.getElementById("mag").innerHTML ="Magazine: 50 Round Mags";
            
        }
        if (mag == 2) {
            document.getElementById("mag").innerHTML ="Magazine: 60 Round Mags";
            
        }
        if (mag == 3) {
            document.getElementById("mag").innerHTML ="Magazine: 9mm Para 32-Round Mags";
            
        }
        if (mag == 4) {
            document.getElementById("mag").innerHTML ="Magazine: .458 SOCOM 10-Round Mags";
