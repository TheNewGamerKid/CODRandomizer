function CR56Amax() {
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        max_barrel = max_barrel - 3
        barrel = Math.floor(Math.random() * (max_barrel - min_barrel) + min_barrel)
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: FSS 8.3\" Intruder";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: XRK Zodiac S440";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: FSS 11.8\" Squall";
    ...
    if (primary_attachments1 === 4 || primary_attachments2 === 4 || primary_attachments3 === 4 || primary_attachments4 === 4 || primary_attachments5 === 4) {
        ...
        if (optic == 7) {
            document.getElementById("optic").innerHTML ="Optics: Solozero Optics Mini-Reflex";
    ...
    if (primary_attachments1 === 5 || primary_attachments2 === 5| primary_attachments3 === 5 || primary_attachments4 === 5 || primary_attachments5 === 5) {
        if (stock == 1) {
            document.getElementById("stock").innerHTML ="Stock: FSS Close Quarters";
            
        }
        if (stock == 2) {
            document.getElementById("stock").innerHTML ="Stock: FTAC Hunter";
        ...
        if (stock == 4) {
            document.getElementById("stock").innerHTML ="Stock: FTAC Spartan";
            
        }
        if (stock == 5) {
            document.getElementById("stock").innerHTML ="Stock: XRK Gatekeeper";
            
        }
        if (stock == 6) {
            document.getElementById("stock").innerHTML ="Stock: CR-56 EXO";
    ...
    if (primary_attachments1 === 6 || primary_attachments2 === 6 || primary_attachments3 === 6 || primary_attachments4 === 6 || primary_attachments5 === 6) {
        ...
        //handle = Rear Grip
        if (handle == 1) {
            document.getElementById("handle").innerHTML ="Rear Grip: XRK CR-56 Granulated Wrap";
            
        }
        if (handle == 2) {
            document.getElementById("handle").innerHTML ="Rear Grip: XRK CR-56 Stippled Wrap";
            
        }
        if (handle == 3) {
            document.getElementById("handle").innerHTML ="Rear Grip: XRK CR-56 Rubberized Wrap";
    ...
    if (primary_attachments1 === 7 || primary_attachments2 === 7 || primary_attachments3 === 7 || primary_attachments4 === 7 || primary_attachments5 === 7) {
        ...
        if (mag == 1) {
            document.getElementById("mag").innerHTML ="Magazine: 45 Round Mag";
            
        }
        if (mag == 2) {
            document.getElementById("mag").innerHTML ="Magazine: M67 10-R Mags";
    ...
    if (primary_attachments1 === 8 || primary_attachments2 === 8 || primary_attachments3 === 8 || primary_attachments4 === 8 || primary_attachments5 === 8) {
        ...
        if (perks == 3) {
            document.getElementById("underbarrel").innerHTML ="Perks: Frangible - Wounding";
