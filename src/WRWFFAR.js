function FFAR() {
    if (primary_attachments1 === 1 || primary_attachments2 === 1 || primary_attachments3 === 1 || primary_attachments4 === 1 || primary_attachments5 === 1) {
        if (muzzle == 1) {
            document.getElementById("muzzle").innerHTML ="Muzzle: Muzzle Brake 5.56";
            
        }
        if (muzzle == 2) {
            document.getElementById("muzzle").innerHTML ="Muzzle: Flashguard 5.56";
    ...
    if (primary_attachments1 === 2 || primary_attachments2 === 2 || primary_attachments3 === 2 || primary_attachments4 === 2 || primary_attachments5 === 2) {
        max_body = max_body + 1
        bodt = Math.floor(Math.random() * (max_body - min_body)+ min_body)
        if (body == 1) {
        ...
        if (body == 4) {
            document.getElementById("body").innerHTML ="Body: SWAT 5mw Laser Sight";
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: 17.9\" Ultralight";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: 18.7\" Calvary Lancer";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: 19.5\" Reinforced Heavy";
            
        }
        if (barrel == 4) {
            document.getElementById("barrels").innerHTML ="Barrels: 21.2\" Ranger";
            
        }
        if (barrel == 5) {
            document.getElementById("barrels").innerHTML ="Barrels: 20.3\" Takedown";
            
        }
        if (barrel == 6) {
            document.getElementById("barrels").innerHTML ="Barrels: 19.5\" Task Force";
    ...
    if (primary_attachments1 === 4 || primary_attachments2 === 4 || primary_attachments3 === 4 || primary_attachments4 === 4 || primary_attachments5 === 4) {
        ...
        if (optic == 12) {
            document.getElementById("optic").innerHTML ="Optics: AN/PVS4 Thermal";
    ...
    if (primary_attachments1 === 5 || primary_attachments2 === 5| primary_attachments3 === 5 || primary_attachments4 === 5 || primary_attachments5 === 5) {
        ...
        if (stock == 2) {
            document.getElementById("stock").innerHTML ="Stock: Marathon Pad";
        ...
        if (stock == 4) {
            document.getElementById("stock").innerHTML ="Stock: CQB Pad";
    ...
    if (primary_attachments1 === 6 || primary_attachments2 === 6 || primary_attachments3 === 6 || primary_attachments4 === 6 || primary_attachments5 === 6) {
        ...
        if (handle == 4) {
            document.getElementById("handle").innerHTML ="Handle: SASR Jungle Grip";
    ...
    if (primary_attachments1 === 7 || primary_attachments2 === 7 || primary_attachments3 === 7 || primary_attachments4 === 7 || primary_attachments5 === 7) {
        if (mag == 1) {
            document.getElementById("mag").innerHTML ="Magazine: 34 Rd";
            
        }
        if (mag == 2) {
            document.getElementById("mag").innerHTML ="Magazine: Jungle-Style Mag";
            
        }
        if (mag == 3) {
            document.getElementById("mag").innerHTML ="Magazine: 34 Rd Speed Mags";
            
        }
        if (mag == 4) {
            document.getElementById("mag").innerHTML ="Magazine: STANAG 44 Rd";
        ...
        if (mag == 6) {
            document.getElementById("mag").innerHTML ="Magazine: Salvo 44 Rd Fast Mag";
