function Fal() {
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        ...
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: 18.0\" Ultralight";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: XRK Marksman";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: 13.0\" OSW Para";
    ...
    if (primary_attachments1 === 5 || primary_attachments2 === 5| primary_attachments3 === 5 || primary_attachments4 === 5 || primary_attachments5 === 5) {
        ...
        if (stock == 1) {
            document.getElementById("stock").innerHTML ="Stock: Factory 18\" Aluminum Stock";
    ...
    if (primary_attachments1 === 7 || primary_attachments2 === 7 || primary_attachments3 === 7 || primary_attachments4 === 7 || primary_attachments5 === 7) {
        ...
        if (mag == 1) {
            document.getElementById("mag").innerHTML ="Magazine: 24 Round Mags";
            
        }
        if (mag == 2) {
            document.getElementById("mag").innerHTML ="Magazine: 30 Round Mags";
