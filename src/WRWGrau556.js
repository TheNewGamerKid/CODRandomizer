function Grau556() {
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        ...
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: Tempus 26.4\" Archangel";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: XRK CZEN MK2";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: FSS 20.8\" Nexus";
    ...
    if (primary_attachments1 === 5 || primary_attachments2 === 5| primary_attachments3 === 5 || primary_attachments4 === 5 || primary_attachments5 === 5) {
        max_stock = max_stock - 3
        stock = Math.floor(Math.random() * (max_stock - min_stock) + min_stock)
        if (stock == 1) {
            document.getElementById("stock").innerHTML ="Stock: FSS Blackjack";
            
        }
        if (stock == 2) {
            document.getElementById("stock").innerHTML ="Stock: ZRK StrikeLite III";
    ...
    if (primary_attachments1 === 6 || primary_attachments2 === 6 || primary_attachments3 === 6 || primary_attachments4 === 6 || primary_attachments5 === 6) {
        ...
        //handle = Rear Grip
        if (handle == 1) {
            document.getElementById("handle").innerHTML ="Rear Grip: XRK Void II";
            
        }
        if (handle == 2) {
            document.getElementById("handle").innerHTML ="Rear Grip: Cronen Sniper Elite";
            
        }
        if (handle == 3) {
            document.getElementById("handle").innerHTML ="Rear Grip: FTAC R-89 Rubber";
    ...
    if (primary_attachments1 === 8 || primary_attachments2 === 8 || primary_attachments3 === 8 || primary_attachments4 === 8 || primary_attachments5 === 8) {
        max_underbarrel = max_underbarrel + 6
        ...
        if (underbarrel == 7) {
            document.getElementById("underbarrel").innerHTML ="Underbarrel: Cronen Shark II";
