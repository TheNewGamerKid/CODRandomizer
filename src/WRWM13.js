function M13() {
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        ...
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: Tempus Mini";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: Tempus Cyclone";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: Tempus Marksman";
    ...
    if (primary_attachments1 === 5 || primary_attachments2 === 5| primary_attachments3 === 5 || primary_attachments4 === 5 || primary_attachments5 === 5) {
        ...
        if (stock == 1) {
            document.getElementById("stock").innerHTML ="Stock: Forge TAC Stalker";
        ...
        if (stock == 4) {
            document.getElementById("stock").innerHTML ="Stock: Forge M13 Skeleton Stock";
    ...
    if (primary_attachments1 === 7 || primary_attachments2 === 7 || primary_attachments3 === 7 || primary_attachments4 === 7 || primary_attachments5 === 7) {
        ...
        if (mag == 3) {
            document.getElementById("mag").innerHTML ="Magazine: .300 Blackout 30-Round Mags";
