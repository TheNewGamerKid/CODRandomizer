function Xm4() {
    ...
    if (primary_attachments1 === 3 || primary_attachments2 === 3 || primary_attachments3 === 3 || primary_attachments4 === 3 || primary_attachments5 === 3) {
        if (barrel == 1) {
            document.getElementById("barrels").innerHTML ="Barrels: 11.8\" Ranger";
            
        }
        if (barrel == 2) {
            document.getElementById("barrels").innerHTML ="Barrels: 12.5\" Calvary Lancer";
            
        }
        if (barrel == 3) {
            document.getElementById("barrels").innerHTML ="Barrels: 13.5\" Reinforced Heavy";
            
        }
        if (barrel == 4) {
            document.getElementById("barrels").innerHTML ="Barrels: 13.7\" Extended";
            
        }
        if (barrel == 5) {
            document.getElementById("barrels").innerHTML ="Barrels: 13.7\" Takedown";
            
        }
        if (barrel == 6) {
            document.getElementById("barrels").innerHTML ="Barrels: 13.5\" Task Force";
    ...
    if (primary_attachments1 === 5 || primary_attachments2 === 5| primary_attachments3 === 5 || primary_attachments4 === 5 || primary_attachments5 === 5) {
        ...
        if (stock == 4) {
            document.getElementById("stock").innerHTML ="Stock: Buffer Tube";
    ...
    if (primary_attachments1 === 7 || primary_attachments2 === 7 || primary_attachments3 === 7 || primary_attachments4 === 7 || primary_attachments5 === 7) {
        if (mag == 1) {
            document.getElementById("mag").innerHTML ="Magazine: 45 Rd";
        ...
        if (mag == 3) {
            document.getElementById("mag").innerHTML ="Magazine: 45 Rd Speed Mags";
            
        }
        if (mag == 4) {
            document.getElementById("mag").innerHTML ="Magazine: STANAG 60 Rd";
        ...
        if (mag == 6) {
            document.getElementById("mag").innerHTML ="Magazine: Salvo 60 Rd Fast Mag";
